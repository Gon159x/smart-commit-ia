export default {
  ...
  errorParsing: "⚠️ Error parseando",
  fileReadWarning: "⚠️ No se pudo leer el archivo:",
  analyzingDeleted: "🔍 Analizando archivos eliminados/refactorizados...",
  deletedSummarySuccess: "✅ Archivos eliminados/refactorizados resumidos",
  verboseDeletedSummary: "🗒️ Resumen de archivos eliminados/refactorizados:\n",
  errorProcessingDeleted: "⚠️ Error procesando archivos eliminados/refactorizados",
  analyzingFile: "🤖 Analizando {file} con IA...",
  fileProcessed: "✅ {file} procesado correctamente",
  verboseAnalyzeResponse: "🗒️ Respuesta de analyzeDiffBlock:\n",
  errorProcessingFile: "⚠️ Error al procesar {file}",
  ...
  errorParsingJSON: "⚠️ Error parseando JSON del bloque:",
  errorAnalyzeDiffBlock: "⚠️ Error en analyzeDiffBlock:",
  errorSummarizeGroup: "⚠️ Error al resumir grupo:",
  ...
  operationCancelled: "⚠️ Operación cancelada por el usuario.",
  messagesCopied: "📋 Mensajes copiados al portapapeles.",
  commitSuccess: "✅ Commit realizado con éxito.",
  changelogEntryAdded: "🗒️ Entrada de CHANGELOG agregada.",
  ...
  noChangelogChanges: "🗒️ No hubo cambios en CHANGELOG.md. No se hizo commit.",
  ...
  largeDiffPrompt:
    "El diff de {file} tiene unas {lines} líneas. ¿Qué querés hacer?",
  largeDiffAnalyze: "Analizar con IA (puede tardar o consumir tokens)",
  largeDiffSkipWithNote: "Saltar el análisis y agregar una nota simple",
  largeDiffSkip: "Saltar el análisis e ignorar este archivo",
  binaryFileSkipped: "Archivo binario detectado, se omite el diff de: {file}",
  largeDiffSkipped:
    "Diff grande omitido para {file} (~{lines} líneas) por elección del usuario.",
  largeDiffNoted:
    "Se agregó una nota de marcador para el diff grande en {file} (~{lines} líneas).",
};
